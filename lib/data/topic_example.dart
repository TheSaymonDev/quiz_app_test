...
List<Map> topicListNational = [
  ...
  {'name': 'উপমহাদেশে ইউরোপীয়দের আগমন', 'color': Colors.greenAccent, 'color2':  Colors.green,'imgUrl':'images/icon5.png', 'pdfName': 'sample_5.pdf'},
  {'name': 'ইংরেজ শাসন', 'color': Colors.purpleAccent, 'color2':  Colors.purple,'imgUrl':'images/icon5.png', 'pdfName': 'sample_6.pdf'},
  {'name': 'বাংলার সংস্কার আন্দোলন', 'color': Colors.deepOrangeAccent, 'color2':  Colors.deepOrange,'imgUrl':'images/icon6.png', 'pdfName': 'sample_7.pdf'},
  {'name': 'বাংলার শিক্ষা সংস্কার ও সংস্কারক', 'color': Colors.blueAccent, 'color2':  Colors.blue[900],'imgUrl':'images/icon6.png', 'pdfName': 'sample_8.pdf'},
  {'name': 'বাংলার রাজনৈতিক আন্দোলন', 'color': Colors.pinkAccent, 'color2':  Colors.pink,'imgUrl':'images/icon7.png', 'pdfName': 'sample_9.pdf'},
  {'name': 'পাকিস্তান আমল', 'color': Colors.orangeAccent, 'color2':Colors.orange,'imgUrl':'images/icon8.png', 'pdfName': 'sample_10.pdf'},
  {'name': 'মহান মুক্তিযুদ্ধ', 'color': Colors.cyanAccent, 'color2':Colors.cyan,'imgUrl':'images/icon9.png', 'pdfName': 'sample_11.pdf'},
  {'name': 'বাংলাদেশ পরিচিতি', 'color': Colors.deepPurpleAccent, 'color2':Colors.deepPurple,'imgUrl':'images/icon10.png', 'pdfName': 'sample_12.pdf'},
  {'name': 'বাংলাদেশের অবস্থান, আয়তন ও সীমানা', 'color': Colors.lightGreenAccent, 'color2':Colors.lightGreen,'imgUrl':'images/icon11.png', 'pdfName': 'sample_13.pdf'},
  {'name': 'বাংলাদেশের আবহাও্যা ও জলবায়ু', 'color': Colors.tealAccent, 'color2':Colors.teal,'imgUrl':'images/icon12.png', 'pdfName': 'sample_14.pdf'},
  {'name': 'বাংলাদেশের প্রথম', 'color': Colors.indigoAccent, 'color2':Colors.indigo,'imgUrl':'images/icon13.png', 'pdfName': 'sample_15.pdf'},
  {'name': 'বাংলাদেশের জাতীয় বিষয়াবলী', 'color': Colors.limeAccent, 'color2':Colors.lime,'imgUrl':'images/icon14.png', 'pdfName': 'sample_16.pdf'},
  {'name': 'বাংলাদেশের শিক্ষা', 'color': Colors.deepPurpleAccent, 'color2':Colors.deepPurple,'imgUrl':'images/icon15.png', 'pdfName': 'sample_17.pdf'},
  {'name': 'বাংলাদেশের সংবিধান', 'color': Colors.lightBlueAccent, 'color2':Colors.lightBlue,'imgUrl':'images/icon16.png', 'pdfName': 'sample_18.pdf'},
  {'name': 'জাতীয় সংসদ', 'color': Colors.blueGrey, 'color2':Colors.blueGrey[900], 'imgUrl':'images/icon17.png', 'pdfName': 'sample_19.pdf'},
  {'name': 'গণভোট ও সংসদ নির্বাচন', 'color': Colors.brown, 'color2':Colors.brown[900],'imgUrl':'images/icon18.png', 'pdfName': 'sample_20.pdf'},
  {'name': 'বাংলাদেশের সাংবিধানিক সংস্থা', 'color': Colors.redAccent, 'color2': Colors.red, 'imgUrl':'images/icon19.png', 'pdfName': 'sample_21.pdf'},
  {'name': 'বাংলাদেশ সরকারের প্রশাসনিক ব্যবস্থা', 'color': Colors.greenAccent, 'color2': Colors.green,'imgUrl':'images/icon20.png', 'pdfName': 'sample_22.pdf'},
  {'name': 'জনসঙ্ক্যা ও ক্ষুদ্র নৃগোষ্ঠী', 'color': Colors.yellowAccent, 'color2': Colors.yellow,'imgUrl':'images/icon21.png', 'pdfName': 'sample_23.pdf'},
  {'name': 'বাংলাদেশের নদী, সমুদ্রবন্দর ও বাঁধ', 'color': Colors.blueAccent, 'color2':   Colors.blue[900],'imgUrl':'images/icon22.png', 'pdfName': 'sample_24.pdf'},
  {'name': 'বাংলাদেশের পাহাড়, পর্বত, চর বন্দর ও অন্যান্য', 'color': Colors.purpleAccent, 'color2':  Colors.purple,'imgUrl':'images/icon23.png', 'pdfName': 'sample_25.pdf'},
  {'name': 'ভৌগলিক উপনাম, বর্তমান ও পুরাতন নাম', 'color': Colors.deepOrangeAccent, 'color2':  Colors.deepOrange,'imgUrl':'images/icon24.png', 'pdfName': 'sample_26.pdf'},
  {'name': 'বাংলাদেশের সম্পদ', 'color': Colors.pinkAccent, 'color2':  Colors.pink,'imgUrl':'images/icon25.png', 'pdfName': 'sample_27.pdf'},
  {'name': 'বাংলাদেশের শিল্প', 'color': Colors.orangeAccent, 'color2':Colors.orange,'imgUrl':'images/icon26.png', 'pdfName': 'sample_28.pdf'},
  {'name': 'বাংলাদেশের অর্থনীতি', 'color': Colors.cyanAccent, 'color2':Colors.cyan,'imgUrl':'images/icon27.png', 'pdfName': 'sample_29.pdf'},
  {'name': 'বাংলাদেশের জাতীয় দিবস', 'color': Colors.deepPurpleAccent, 'color2':Colors.deepPurple,'imgUrl':'images/icon28.png', 'pdfName': 'sample_30.pdf'},
  {'name': 'বাংলাদেশের শিল্প-সাহিত্য ও সংস্কৃতি', 'color': Colors.lightGreenAccent, 'color2':Colors.lightGreen,'imgUrl':'images/icon29.png', 'pdfName': 'sample_31.pdf'},
  {'name': 'বাংলার প্রাচীন স্থাপত্য', 'color': Colors.tealAccent, 'color2':Colors.teal,'imgUrl':'images/icon30.png', 'pdfName': 'sample_32.pdf'},
  {'name': 'বাংলাদেশের ভাস্কর, ভাস্কর্য ও অবস্থান', 'color': Colors.indigoAccent, 'color2':Colors.indigo,'imgUrl':'images/icon31.png', 'pdfName': 'sample_33.pdf'},
  {'name': 'বিভিন্ন প্রতিষ্ঠান, একাডেমি ও কমিশন', 'color': Colors.limeAccent, 'color2':Colors.lime,'imgUrl':'images/icon32.png', 'pdfName': 'sample_34.pdf'},
  {'name': 'আন্তর্জাতিক ক্ষেত্রে বাংলাদেশ', 'color': Colors.deepPurpleAccent, 'color2':Colors.deepPurple,'imgUrl':'images/icon33.png', 'pdfName': 'sample_35.pdf'},
  {'name': 'বাংলাদেশের চুক্তি', 'color': Colors.lightBlueAccent, 'color2':Colors.lightBlue,'imgUrl':'images/icon34.png', 'pdfName': 'sample_36.pdf'},
  {'name': 'বাংলাদেশের প্রতিরক্ষা ও নিরাপত্তা বাহিনী', 'color': Colors.blueGrey, 'color2':Colors.blueGrey[900], 'imgUrl':'images/icon35.png', 'pdfName': 'sample_37.pdf'},
  {'name': 'পরিবহন ও যোগাযোগ ব্যবস্থা', 'color': Colors.brown, 'color2':Colors.brown[900],'imgUrl':'images/icon36.png', 'pdfName': 'sample_38.pdf'},
  {'name': 'বাংলাদেশের গণমাধ্যম', 'color': Colors.redAccent, 'color2': Colors.red, 'imgUrl':'images/icon37.png', 'pdfName': 'sample_39.pdf'},
  {'name': 'বাংলাদেশের দর্শনীয় স্থান', 'color': Colors.greenAccent, 'color2': Colors.green,'imgUrl':'images/icon38.png', 'pdfName': 'sample_40.pdf'},
  {'name': 'কবি সাহিত্যিকদের ছদ্মনাম,উপাধি,মহাকাব্য', 'color': Colors.yellowAccent, 'color2': Colors.yellow,'imgUrl':'images/icon39.png', 'pdfName': 'sample_41.pdf'},
  {'name': 'সংক্ষেপ ও খেলাধুলা', 'color': Colors.blueAccent, 'color2':   Colors.blue[900],'imgUrl':'images/icon40.png', 'pdfName': 'sample_42.pdf'},
];
