...
class ResultPage extends StatefulWidget {
   ResultPage({Key? key, this.score, this.outOf}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Text('Congratulation', style: myStyle(40, FontWeight.bold, whiteClr),),
            Text('You Got $result', style: myStyle(40, FontWeight.bold, yellowClr),),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text('Finish', style: myStyle(18, FontWeight.bold, containerClr2),),
              ),
            )
          ],
        ),
